            ...
            <table class="table table-hover" style="border-radius: 10px; overflow: hidden;">
              ...
              <tbody>
                ...
                <tr style="transition: all 0.3s ease;">
                  <td>{{$index + 1}}</td>
                  <td style="color: #388E3C; font-weight: bold; font-size: 1.1em;">{{$category->categoryname}}</td>
                  <td><img src="/Uploads/{{$category->categoryimage}}" alt="Category Image" style="width: 80px; height: auto; border-radius: 8px;"></td>
                  <td>
                    <!-- Confirmation Alert for Deletion -->
                    <a href="#" onclick="confirmDelete({{ $category->categoryid }})">
