            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card" style="background-color: #e6f7e6; border: 1px solid #c8e6c9;">
                    <div class="card-body">
                        ...
                        <form action="{{route('updatecategory', $category->categoryid)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="exampleInputcategoryname" style="color: #1b5e20;">Category Name</label>
                                <input type="text" name="category" class="form-control" id="exampleInputcategoryname" value="{{$category->categoryname}}" placeholder="Category Name" style="background-color: #ffffff; border: 1px solid #aed581;">

                                <label for="exampleInputimage" style="color: #1b5e20; margin-top: 10px;">Image</label>
                                <input type="hidden" value="{{$category->categoryimage}}" name="oldimage">
