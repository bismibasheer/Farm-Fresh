...
@section('content')
    ...
    <div class="container mt-4">
        ...
        <form method="GET" action="{{ route('ReportDate') }}" class="row g-3 justify-content-center mb-4">
            <div class="col-md-4">
                <input 
                    type="date" 
                    name="from_date" 
                ...
                <tbody>
                    @foreach ($bookings as $booking)
                        <tr>
                            ...
                            <td class="text-center">{{ \Carbon\Carbon::parse($booking->requestdate)->format('d M Y') }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
