          ...
          <div class="table-responsive" style="margin-top: 30px;">
            <table class="table table-hover" style="background-color: #FFFFFF; border-radius: 10px; box-shadow: 0px 4px 15px rgba(0, 0, 0, 0.1);">
              ...
              <tbody>
                ...
                <tr>
                  <td style="color: #388E3C; font-weight: bold; font-size: 14px; text-align: center;"><?php echo e($index + 1); ?></td>
                  <td style="color: #388E3C; font-weight: bold; font-size: 14px; text-align: center;"><?php echo e($district->districtname); ?></td>
                </tr>
...
<?php echo $__env->make('Layouts.AdminMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel projects\AgricultureShopping\resources\views/Admin/Viewdistrict.blade.php ENDPATH**/ ?>