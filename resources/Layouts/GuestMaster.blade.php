...
<head>
    ...
    <!-- Site Icons -->
    <link rel="shortcut icon" href="{{asset('Guest/images/favicon.ico')}}" type="image/x-icon">
    <link rel="apple-touch-icon" href="{{asset('Guest/images/apple-touch-icon.png')}}">
    ...
    <div class="main-top">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
    <div class="login-box">
        <a class="nav-link" href="{{route('login_page')}}">Login / Sign Up</a>
    </div>
</div>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img src="{{asset('Guest/images/farm-fresh-.jpg')}}" class="logo" style="width: 250px; height: 75px;" alt=""></a>
                </div>
            ...
            <div class="side">
                ...
                <li class="cart-box">
                    <ul class="cart-list">
                        <li>
                            <a href="#" class="photo"><img src="{{asset('Guest/images/img-pro-01.jpg')}}" class="cart-thumb" alt="" /></a>
                            <h6><a href="#">Delica omtantur </a></h6>
                            <p>1x - <span class="price">$80.00</span></p>
                        </li>
                        <li>
                            <a href="#" class="photo"><img src="{{asset('Guest/images/img-pro-02.jpg')}}" class="cart-thumb" alt="" /></a>
                            <h6><a href="#">Omnes ocurreret</a></h6>
                            <p>1x - <span class="price">$60.00</span></p>
                        </li>
                        <li>
                            <a href="#" class="photo"><img src="{{asset('Guest/images/img-pro-03.jpg')}}" class="cart-thumb" alt="" /></a>
    ...
    <div id="slides-shop" class="cover-slides">
        <ul class="slides-container">
            <li class="text-center">
                <img src="{{asset('Guest/images/categories_img_03.jpg')}}" alt="">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
            ...
            <li class="text-center">
                <img src="{{asset('Guest/images/banner-02.jpg')}}" alt="">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong>Welcome To <br>Farm Fresh</strong></h1>
            ...
            <li class="text-center">
                <img src="{{asset('Guest/images/blog-img-02.jpg')}}" alt="">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong>Welcome To <br>Farm Fresh</strong></h1>
...
<!-- End Instagram Feed -->
    ...
    <!-- ALL PLUGINS -->
    <script src="{{asset('Guest/js/jquery.superslides.min.js')}}"></script>
    <script src="{{asset('Guest/js/bootstrap-select.js')}}"></script>
    <script src="{{asset('Guest/js/inewsticker.js')}}"></script>
    <script src="{{asset('Guest/js/bootsnav.js.')}}"></script>
    <script src="{{asset('Guest/js/images-loded.min.js')}}"></script>
    <script src="{{asset('Guest/js/isotope.min.js')}}"></script>
    <script src="{{asset('Guest/js/owl.carousel.min.js')}}"></script>
    <script src="{{asset('Guest/js/baguetteBox.min.js')}}"></script>
    <script src="{{asset('Guest/js/form-validator.min.js')}}"></script>
    <script src="{{asset('Guest/js/contact-form-script.js')}}"></script>
