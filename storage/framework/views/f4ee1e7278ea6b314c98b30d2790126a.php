                ...
                <center><h4 class="card-title" style="color: #2E7D32; font-weight: bold; margin-bottom: 20px;">PRODUCT</h4></center>
                    ...
                    <div class="card-body" style="background-color: #FFFDD0; padding: 30px; border-radius: 0 0 10px 10px;">
                        <div class="d-flex justify-content-end mb-3">
                            <a href="<?php echo e(route('viewproduct')); ?>">
                        ...
                        <form action="<?php echo e(route('productinsert')); ?>" enctype="multipart/form-data" method="POST" id="product">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('Layouts.AdminMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel projects\AgricultureShopping\resources\views/Admin/product.blade.php ENDPATH**/ ?>