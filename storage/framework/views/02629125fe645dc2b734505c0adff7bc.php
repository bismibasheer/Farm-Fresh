  ...
  <div class="row d-flex justify-content-center">
    <div class="col-md-10 col-lg-8 col-xl-5">
      <div class="card rounded-3">
        ...
        <?php $__currentLoopData = $booking; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="text-center mb-4">
            <h3>Make Your </h3>
            <h6>Payment</h6>
          </div>
          <form action="<?php echo e(route('paymentinsert')); ?>" method="POST">
          <?php echo csrf_field(); ?>
          <input type="hidden" name="requestid" value="<?php echo e($p->requestid); ?>">
            ...
            <div data-mdb-input-init class="form-outline mb-4">
              <input type="text" id="formControlLgXsd" class="form-control form-control-lg"
                value="<?php echo e($p->customer->customername); ?>" />
              <label class="form-label" for="formControlLgXsd">Card Holder Name</label>
            </div>


            <div data-mdb-input-init class="form-outline mb-4">
              <input type="text" id="formControlLgXsd" class="form-control form-control-lg"
                value="<?php echo e($p->totalamount); ?>" />
              <label class="form-label" for="formControlLgXsd">Total Amount</label>
            </div>
...
<?php echo $__env->make('Layouts.CustomerMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel projects\AgricultureShopping\resources\views/Customer/payment.blade.php ENDPATH**/ ?>