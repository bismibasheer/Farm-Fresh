...
<div id="slides-shop" class="cover-slides">
    <ul class="slides-container">
        <li class="text-center">
            <img src="<?php echo e(asset('Customer/images/categories_img_03.jpg')); ?>" alt="">
            <div class="container">
        ...
        <li class="text-center">
            <img src="<?php echo e(asset('Customer/images/banner-02.jpg')); ?>" alt="">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-12 text-center">
                        <h1 class="m-b-20"><strong>Welcome To <br> Farm Fresh</strong></h1>
        ...
        <li class="text-center">
            <img src="<?php echo e(asset('Customer/images/blog-img-02.jpg')); ?>" alt="">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-12 text-center">
                        <h1 class="m-b-20"><strong>Welcome To <br> Farm Fresh</strong></h1>
...
<?php echo $__env->make('Layouts.CustomerMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel projects\AgricultureShopping\resources\views/Customer/Customerhome.blade.php ENDPATH**/ ?>